...
function emd_lite_get_operations($type,$plural_label,$textdomain){
	...
	elseif($type == 'cust_fields'){
		...
		<div class="emd-oper-modal-button">
			<a href="' . esc_url("https://emdplugins.com/plugin-pricing/software-issue-manager-wordpress-plugin-pricing/?pk_campaign=" . esc_attr($app) . "-cust-fields&pk_kwd=upgradelink") . '" class="emdmodalbtn" target="_blank" rel="noopener noreferrer">';
