...
function software_issue_manager_frontend_scripts() {
	...
	wp_register_script('emd-widg-paging-js', $dir_url . 'assets/js/emd-widg-paging.js', '', SOFTWARE_ISSUE_MANAGER_VERSION, true);
...
function software_issue_manager_enq_custom_css_js() {
	...
	if (!empty($tools['custom_css'])) {
		...
		wp_register_style('software-issue-manager-custom', false);
		wp_enqueue_style('software-issue-manager-custom');
		wp_add_inline_style('software-issue-manager-custom', $tools['custom_css']);
	}
	if (!empty($tools['custom_js'])) {
		...
		wp_register_script('software-issue-manager-custom', false);
		wp_enqueue_script('software-issue-manager-custom');
		wp_add_inline_script('software-issue-manager-custom', $tools['custom_js']);
	}
}
/**
